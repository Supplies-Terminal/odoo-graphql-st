...
schema = graphene.Schema(
    query=Query,
    mutation=Mutation,
    types=[website.WebsiteList, company.CompanyList, country.CountryList, category.CategoryList, product.ProductList, product.ProductVariantData, order.OrderList,
