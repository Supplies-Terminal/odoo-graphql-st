...
class GraphQLController(http.Controller, GraphQLControllerMixin):
    ...
    @http.route("/graphql/st", auth="public", cors="https://webapp.suppliesterminal.com", csrf=False, website=True)
    def graphql(self, **kwargs):
        self._set_website_context()
        resp = self._handle_graphql_request(schema.graphql_schema)

        # resp.headers['Access-Control-Allow-Origin'] = 'https://webapp.suppliesterminal.com'
